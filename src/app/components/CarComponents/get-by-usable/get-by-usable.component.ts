...
export class GetByUsableComponent implements OnInit {
  ...
  createCarAddForm() {
    this.getByUsable = this.formBuilder.group({
      ...
      userId: ['', this.getRole() == 'Yönetici' ? Validators.required : ''],
    });
  }
  dataLoaded = false;
  gunHesapla() {
